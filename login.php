...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <a href="adminlogin.php">
            <input type="button" value="Admin Login" class="admin-btn">
        </a>
		
		 <a href="homep.php">
            <input type="button" value="home page" class="home-btn">
        </a>
    </form>
</div>
...
if (isset($_POST['sb'])) {
    if (!empty($_POST['un']) && !empty($_POST['pw'])) {
        ...
        $stmt = $conn->query("SELECT * FROM usertbl WHERE username ='$username'");
        $stmt->execute();
